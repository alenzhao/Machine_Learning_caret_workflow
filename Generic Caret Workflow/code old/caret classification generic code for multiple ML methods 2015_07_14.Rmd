...
table(dataRaw$Class)
imbalanceTable <- table(dataRaw$Class)

if(imbalanceTable[[1]] >= imbalanceTable[[2]] ) {
  print(paste("Ratio of ", imbalanceTable[1], "to", imbalanceTable[2], "is", 
              round(imbalanceTable[[1]] / imbalanceTable[[2]] , 2)))
} else {
    print(paste("Ratio of ", imbalanceTable[2], "to", imbalanceTable[1], "is", 
              round(imbalanceTable[[2]] / imbalanceTable[[1]] , 2)))
}
